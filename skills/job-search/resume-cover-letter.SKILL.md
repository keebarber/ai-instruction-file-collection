<!--
SOURCE: jezweb/claude-skills — https://github.com/jezweb/claude-skills/blob/main/plugins/writing/skills/resume-cover-letter/SKILL.md
Retrieved 2026-06-26, verbatim. Install: copy this file into a `resume-cover-letter/` folder under your skills dir.
Pairs with: ../../career-context/candidate-profile.md (feed that in as the "candidate background" input).
-->
---
