...
> SOURCE: conorbronsdon/avoid-ai-writing — https://github.com/conorbronsdon/avoid-ai-writing (MIT). Saved verbatim 2026-06-26.
> This is one of the best-maintained, most concrete "words/patterns to avoid" references available. Drop it in `~/.claude/skills/` or reference it from a CLAUDE.md.
